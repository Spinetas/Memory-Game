...
function gameOver(moves, score) {
    $('#winnerText').text(`Congratulations! It took ${second} seconds and ${moves} moves to complete game, with a score of ${score}.  
    Well done!`);
    $('#winnerModal').modal('toggle');
}

// Clicking on the button located on the top right of the game, enables the cards to be reset
